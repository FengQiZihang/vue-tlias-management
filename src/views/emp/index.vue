...
// 侦听employee对象的exprList日期范围变化exprDate
watch(
  ...
  employeeFormRef.value.validate(async (valid) => {
    if (valid) {
      ...
      if (employee.value.id) {
        // 编辑
        console.log('编辑员工', employee.value) // 调试
        result = await updateApi(employee.value)
      } else {
        // 新增
        console.log('新增员工', employee.value) // 调试
...
const deleteByIds = async () => {
  ...
  // 弹出确认框
  ElMessageBox.confirm('是否删除选中的员工?', '提示', {
    confirmButtonText: '确定',
    cancelButtonText: '取消',
    type: 'warning'
  }).then(async () => {
...
<template>
  ...
  <el-form :inline="true" :model="searchEmp" class="demo-form-inline">
    ...
    <el-form-item label="性别">
      <el-select v-model="searchEmp.gender" placeholder="请选择" style="width: 150px">
  ...
  <el-table :data="empList" border style="width: 100%" @selection-change="handleSelectionChange">
    ...
    <el-table-column prop="deptName" label="所属部门" width="120px" align="center" />
    <!-- 职位, 说明: 1 班主任,2 讲师, 3 学工主管, 4 教研主管, 5 咨询师 -->
    <el-table-column prop="job" label="职位" width="120px" align="center">
      <template #default="scope">
    ...
    <el-table-column prop="updateTime" label="最后修改时间" width="200px" align="center" />
